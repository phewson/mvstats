...
<<inversions, fig = FALSE, echo = TRUE, results = hide>>=
...
<<sterling, fig =FALSE, echo = TRUE, results = hide>>=
...
<<r11, fig = FALSE, results = hide, echo = TRUE>>=
R11 <- R[1:2,1:2]
R12 <- R[1:2,3:5]
R21 <- R[3:5,1:2]
R22 <- R[3:5,3:5]
...
<<findA, fig = FALSE, results = hide, echo = TRUE>>=
...
<<eigen, fig = FALSE, results = hide, echo = TRUE>>=
eigen(B)
sqrt(eigen(A)$values)
sqrt(eigen(B)$values)
