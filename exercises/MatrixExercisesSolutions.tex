...
Solutions are (a) $\left( \begin{array}{rrr} 0.333 & 0 & 0 \\ 0 & 0.25 & 0 \\ 0 & 0 & 0.111 \end{array} \right)$, note the determinant is 108 \\
(b) $\left( \begin{array}{rr} 0.714 & -0.429 \\ -0.143 & 0.286  \end{array} \right)$ (with a determinant of 7), \\
(c)  $\left( \begin{array}{rrr} 0.294 & 0.118 & -0.265 \\ 0.029 & -0.088 & 0.325 \\ -0.059 & 0.176 & -0.147 \end{array} \right)$ (with a determinant of -68) and \\
(d) $ \left( \begin{array}{rrr} 0.222 & -0.111 & 0.333 \\ 0.056 & 0.222 & -0.167 \\ 0.722 & -0.111 & -0.l67 \end{array} \right)$ (with a determinant -18)
